...
LOGGING = {
    ...
    'handlers': {
        ...
        'file_about_app': {
            'class': 'logging.FileHandler',
            'filename': './log/about_app.log',
            'formatter': 'verbose',
        },
        'file_myapp2': {
            'class': 'logging.FileHandler',
            'filename': './log/myapp2.log',
            'formatter': 'verbose',
        },
        'file_myapp3': {
            'class': 'logging.FileHandler',
            'filename': './log/myapp3.log',
            'formatter': 'verbose',
        },
        'file_myapp4': {
            'class': 'logging.FileHandler',
    ...
    'loggers': {
        ...
        'about_app': {
            # 'handlers': ['console'],
            'handlers': ['console', 'file_about_app'],
